...
public final class ArrayQueue<T> implements QueueInterface<T> {
    ...
    public void splice(ArrayQueue<T> anotherQueue) {
        int length = anotherQueue.queue.length;
        int fIndex = anotherQueue.frontIndex;
        int bIndex = anotherQueue.backIndex;
        for (int i = fIndex; i != (bIndex + 1) % length; i = (i + 1) % length) {
